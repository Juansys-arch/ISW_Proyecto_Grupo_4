...
export const finalizarJornada = async (id, horaLlegada) => {
    try {
        const response = await axios.post(`/transporte/${id}/finalizar-jornada`, {
            horaLlegada,
        });
        return response.data;
    } catch (error) {
...
export const verificarKitsIncompletos = async () => {
    try {
        const response = await axios.get('/kits/verificar/incompletos');
        return response.data;
    } catch (error) {
        return { status: 'Error', message: error?.response?.data?.message || error.message };
    }
...
export const marcarKitIncompleto = async (id, razon) => {
    try {
        const response = await axios.post(`/kits/${id}/marcar-incompleto`, {
            razon,
        });
        return response.data;
    } catch (error) {
